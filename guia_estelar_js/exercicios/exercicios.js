...
Crie um algoritmo que transforme as notas do sistema numérico para sistema de 
...
function booksOfAuthor(author) {
      ...
      console.log(`Livros do autor ${author}: ${books.join(", ")}`) // Transforma o array em string
}
